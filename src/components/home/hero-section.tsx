        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-1000">
            <div className="inline-flex items-center gap-2.5 rounded-full px-5 py-2 glass-pill shadow-sm hover:border-amber-400/40 transition-all cursor-default">
              ...
              <span className="font-bold text-zinc-900">Premium AI Video Generation</span>
            </div>
          </div>
          ...
          {/* CTAs */}
          <div className="flex flex-col items-center gap-3 animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-450">
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Button
                size="lg"
                asChild
                className="h-16 px-12 rounded-2xl hover:bg-amber-600 text-white font-extrabold text-xl transition-all hover:scale-[1.05] active:scale-95"
              >
                <Link href={isAuthenticated ? "/generate" : "/register?pack=starter"}>
                  <Sparkles className="h-4 w-4 fill-amber-500 text-amber-500 mr-2" />
                  Start testing · $4.99
                </Link>
              </Button>
            ...
            <p className="text-xs text-zinc-400 flex items-center gap-2">
              ...
              No subscription · one-time payment · credits never expire · subscribe when you're ready
            </p>
          </div>

          {/* Video mockup */}
          <div className="w-full rounded-xl mt-12 max-w-5xl mx-auto animate-in fade-in zoom-in-95 duration-1000 delay-1000">
