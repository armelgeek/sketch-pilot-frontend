    ...
    <Card className="w-full max-w-sm mx-4 bg-white rounded-2xl shadow-sm border border-zinc-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-xs text-zinc-400 hover:text-amber-600 font-medium transition-colors">
                Oublié ?
              </Link>
            </div>
            <Input
      ...
      <CardFooter className="justify-center pt-0">
        <p className="text-sm text-zinc-500">
          ...
          <Link href="/register" className="font-bold text-zinc-900 hover:text-amber-600 transition-colors">
            S&apos;inscrire
          </Link>
        </p>
      </CardFooter>
